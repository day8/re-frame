...
var len__10660__auto___15965 = arguments.length;
var i__10661__auto___15966 = (0);
while(true){
if((i__10661__auto___15966 < len__10660__auto___15965)){
args__10667__auto__.push((arguments[i__10661__auto___15966]));

var G__15967 = (i__10661__auto___15966 + (1));
i__10661__auto___15966 = G__15967;
continue;
} else {
}
break;
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq15963){
var G__15964 = cljs.core.first(seq15963);
var seq15963__$1 = cljs.core.next(seq15963);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__15964,seq15963__$1);
});
...
var G__15970 = (function (){
sb.append(ch);

return sb;
})()
;
var G__15971 = cljs.reader.read_char(rdr);
sb = G__15970;
ch = G__15971;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__15981 = (groups[(6)]);
var G__15982 = (10);
return parseInt(G__15981,G__15982);
})()]:[null,null]
))));
var n = (a[(0)]);
var radix = (a[(1)]);
...
var G__15983 = cljs.reader.read_char(rdr);
ch = G__15983;
continue;
} else {
return ch;
...
var G__15992 = (((mret === rdr))?a:(function (){
a.push(mret);
...
if((i > (0))){
var G__15994 = (i - (1));
var G__15995 = r.cljs$core$ICollection$_conj$arity$2(null,(arr[(i - (1))]));
i = G__15994;
r = G__15995;
continue;
} else {
...
;
var G__15997 = cljs.reader.read_char(reader);
buffer = G__15996;
ch = G__15997;
continue;
}
...
if(("\\" === ch)){
var G__16000 = (function (){
buffer.append(cljs.reader.escape_char(buffer,reader));

return buffer;
})()
;
var G__16001 = cljs.reader.read_char(reader);
buffer = G__16000;
ch = G__16001;
continue;
} else {
...
var G__16002 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__16003 = cljs.reader.read_char(reader);
buffer = G__16002;
ch = G__16003;
continue;
...
var G__16008 = (function (){var G__16006 = buffer;
G__16006.append(nch);

return G__16006;
})();
var G__16009 = cljs.reader.read_char(reader);
buffer = G__16008;
ch = G__16009;
continue;
}
...
var G__16010 = (function (){var G__16007 = buffer;
G__16007.append(ch);

return G__16007;
})();
var G__16011 = cljs.reader.read_char(reader);
buffer = G__16010;
ch = G__16011;
continue;
...
var G__16040 = reader;
var G__16041 = eof_is_error;
var G__16042 = sentinel;
var G__16043 = is_recursive;
reader = G__16040;
eof_is_error = G__16041;
sentinel = G__16042;
is_recursive = G__16043;
continue;
} else {
if(cljs.reader.comment_prefix_QMARK_(ch)){
var G__16044 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__16123 = temp__6736__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16123,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16123,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16123,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16123,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16123,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16123,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16123,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16123,(7),null);
...
var arr = [];
var seq__16226_16256 = cljs.core.seq(form);
var chunk__16227_16257 = null;
var count__16228_16258 = (0);
var i__16229_16259 = (0);
while(true){
if((i__16229_16259 < count__16228_16258)){
var x_16264 = chunk__16227_16257.cljs$core$IIndexed$_nth$arity$2(null,i__16229_16259);
arr.push(x_16264);

var G__16265 = seq__16226_16256;
var G__16266 = chunk__16227_16257;
var G__16267 = count__16228_16258;
var G__16268 = (i__16229_16259 + (1));
seq__16226_16256 = G__16265;
chunk__16227_16257 = G__16266;
count__16228_16258 = G__16267;
i__16229_16259 = G__16268;
continue;
} else {
var temp__6738__auto___16269 = cljs.core.seq(seq__16226_16256);
if(temp__6738__auto___16269){
var seq__16226_16273__$1 = temp__6738__auto___16269;
if(cljs.core.chunked_seq_QMARK_(seq__16226_16273__$1)){
var c__10350__auto___16274 = cljs.core.chunk_first(seq__16226_16273__$1);
var G__16275 = cljs.core.chunk_rest(seq__16226_16273__$1);
var G__16276 = c__10350__auto___16274;
var G__16277 = cljs.core.count(c__10350__auto___16274);
var G__16278 = (0);
seq__16226_16256 = G__16275;
chunk__16227_16257 = G__16276;
count__16228_16258 = G__16277;
i__16229_16259 = G__16278;
continue;
} else {
var x_16282 = cljs.core.first(seq__16226_16273__$1);
arr.push(x_16282);

var G__16283 = cljs.core.next(seq__16226_16273__$1);
var G__16284 = null;
var G__16285 = (0);
var G__16286 = (0);
seq__16226_16256 = G__16283;
chunk__16227_16257 = G__16284;
count__16228_16258 = G__16285;
i__16229_16259 = G__16286;
continue;
}
} else {
}
...
var obj = {};
var seq__16235_16291 = cljs.core.seq(form);
var chunk__16236_16292 = null;
var count__16237_16293 = (0);
var i__16238_16294 = (0);
while(true){
if((i__16238_16294 < count__16237_16293)){
var vec__16242_16295 = chunk__16236_16292.cljs$core$IIndexed$_nth$arity$2(null,i__16238_16294);
var k_16296 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16242_16295,(0),null);
var v_16297 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16242_16295,(1),null);
(obj[cljs.core.name(k_16296)] = v_16297);

var G__16298 = seq__16235_16291;
var G__16299 = chunk__16236_16292;
var G__16300 = count__16237_16293;
var G__16301 = (i__16238_16294 + (1));
seq__16235_16291 = G__16298;
chunk__16236_16292 = G__16299;
count__16237_16293 = G__16300;
i__16238_16294 = G__16301;
continue;
} else {
var temp__6738__auto___16302 = cljs.core.seq(seq__16235_16291);
if(temp__6738__auto___16302){
var seq__16235_16303__$1 = temp__6738__auto___16302;
if(cljs.core.chunked_seq_QMARK_(seq__16235_16303__$1)){
var c__10350__auto___16307 = cljs.core.chunk_first(seq__16235_16303__$1);
var G__16308 = cljs.core.chunk_rest(seq__16235_16303__$1);
var G__16309 = c__10350__auto___16307;
var G__16310 = cljs.core.count(c__10350__auto___16307);
var G__16311 = (0);
seq__16235_16291 = G__16308;
chunk__16236_16292 = G__16309;
count__16237_16293 = G__16310;
i__16238_16294 = G__16311;
continue;
} else {
var vec__16249_16313 = cljs.core.first(seq__16235_16303__$1);
var k_16314 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16249_16313,(0),null);
var v_16315 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16249_16313,(1),null);
(obj[cljs.core.name(k_16314)] = v_16315);

var G__16320 = cljs.core.next(seq__16235_16303__$1);
var G__16321 = null;
var G__16322 = (0);
var G__16323 = (0);
seq__16235_16291 = G__16320;
chunk__16236_16292 = G__16321;
count__16237_16293 = G__16322;
i__16238_16294 = G__16323;
continue;
}
} else {
}
...
cljs.reader._STAR_tag_table_STAR_ = (function (){var G__16324 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([new cljs.core.PersistentArrayMap(null, 4, ["inst",cljs.reader.read_date,"uuid",cljs.reader.read_uuid,"queue",cljs.reader.read_queue,"js",cljs.reader.read_js], null),cljs.core.PersistentArrayMap.EMPTY], 0));
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__16324) : cljs.core.atom.call(null,G__16324));
})();
...
var G__16341 = cljs.reader.read(rdr,true,null,false);
return (pfn.cljs$core$IFn$_invoke$arity$1 ? pfn.cljs$core$IFn$_invoke$arity$1(G__16341) : pfn.call(null,G__16341));
} else {
if(cljs.core.truth_(dfn)){
var G__16343 = tag;
var G__16344 = cljs.reader.read(rdr,true,null,false);
return (dfn.cljs$core$IFn$_invoke$arity$2 ? dfn.cljs$core$IFn$_invoke$arity$2(G__16343,G__16344) : dfn.call(null,G__16343,G__16344));
} else {
